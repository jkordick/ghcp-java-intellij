# Project: ghcp-java-intellij

This is a documentation/workshop repository. The deliverable is `docs/workshop.md`.

## Conventions

- Workshop content lives in `docs/workshop.md`.
- Code samples are Java 21 / Spring Boot 3.x with Maven.
