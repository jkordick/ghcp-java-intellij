...
- Adding more than the available stock of a duck is rejected with a clear error message (HTTP 409).
- The cart is preserved within a single HTTP session. (Cross-session persistence is out of scope.)
